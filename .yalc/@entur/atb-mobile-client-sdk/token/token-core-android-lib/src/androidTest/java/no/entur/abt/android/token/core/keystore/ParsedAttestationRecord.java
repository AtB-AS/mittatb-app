...
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.ATTESTATION_CHALLENGE_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.ATTESTATION_SECURITY_LEVEL_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.ATTESTATION_VERSION_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.KEYMASTER_SECURITY_LEVEL_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.KEYMASTER_VERSION_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.KEY_DESCRIPTION_OID;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.KM_SECURITY_LEVEL_SOFTWARE;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.KM_SECURITY_LEVEL_STRONG_BOX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.KM_SECURITY_LEVEL_TRUSTED_ENVIRONMENT;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.SW_ENFORCED_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.TEE_ENFORCED_INDEX;
import static no.entur.abt.android.token.core.keystore.AndroidKeyAttestationConstants.UNIQUE_ID_INDEX;
...
public class ParsedAttestationRecord {
	...
	public ParsedAttestationRecord(ASN1Sequence extensionData) {
		...
		this.softwareEnforced = AuthorizationList.createAuthorizationList(((ASN1Sequence) extensionData.getObjectAt(SW_ENFORCED_INDEX)).toArray(),
				attestationVersion);
		this.teeEnforced = AuthorizationList.createAuthorizationList(((ASN1Sequence) extensionData.getObjectAt(TEE_ENFORCED_INDEX)).toArray(),
				attestationVersion);
	}
