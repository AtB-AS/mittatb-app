...
class CryptoExportImportManager: NSObject {
    ...
    func importPublicKeyReferenceFromDERCertificate(_ certData: Data) -> SecKey? {
        ...
        var resultType = SecTrustResultType(rawValue: UInt32(0))! // result will be ignored.
     ...
     */
    func exportRSAPublicKeyToDER(_ rawPublicKeyBytes: Data, keyType _: String, keySize _: Int) -> Data {
    ...
    func exportRSAPublicKeyToPEM(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int) -> String {
        PEMKeyFromDERKey(exportRSAPublicKeyToDER(rawPublicKeyBytes, keyType: keyType, keySize: keySize))
    }
     ...
     * Returns a DER representation of the key.
     */
    func exportECPublicKeyToDER(_ rawPublicKeyBytes: Data, keyType _: String, keySize: Int) -> Data {
    ...
    func exportECPublicKeyToPEM(_ rawPublicKeyBytes: Data, keyType: String, keySize: Int) -> String {
        PEMKeyFromDERKey(exportECPublicKeyToDER(rawPublicKeyBytes, keyType: keyType, keySize: keySize))
    }
