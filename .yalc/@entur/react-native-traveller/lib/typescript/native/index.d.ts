import type { AttestationData, AttestationSupport, LegacyAttestationData, PayloadAction, ReattestationData, Token } from './types';
export declare type EnturTravellerType = {
    ...
    reattest(accountId: string, tokenId: string, nonce: string): Promise<ReattestationData>;
