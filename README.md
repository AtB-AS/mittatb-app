...
1. To setup local development for desired organisation run `yarn setup-atb-dev` or `yarn setup-nfk-dev` to set .env, generate all icons and launch screens for iOS and Android.
