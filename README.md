...
2. From root folder run: `sh scripts/override-environment.sh dev <organization>` where organization is either `atb` or `nfk`, to set root .env for local development
