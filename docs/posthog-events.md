...
| `Ticketing: Pay with previous payment method clicked` | `{paymentMethod, mode}` | `src/stacks-hierarchy/Root_PurchaseConfirmationScreen/Root_PurchaseConfirmationScreen.tsx` |
