...
if [[ 
  ...
  - KEY_ALIAS"
    ...
    ./node_modules/react-native/sdks/hermesc/osx-bin/hermesc -emit-binary -source-map=bundle/temp.bundle.map -output-source-map -out bundle/index.android.bundle bundle/temp.bundle
