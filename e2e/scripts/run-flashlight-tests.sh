...
then
    ...
    ./scripts/handle-flashlight-results.sh 20000 travelsearch
    ...
    ./scripts/handle-flashlight-results.sh 20000 departures
    ...
    ./scripts/handle-flashlight-results.sh 20000 map
