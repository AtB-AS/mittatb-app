...
function SvgSelectionPinConfirm(props: SvgProps) {
  return (
    <Svg width={28} height={37} fill="none" viewBox="0 0 28 37" {...props}>
      ...
      <Path
        fill="#fff"
        fillRule="evenodd"
        d="M21.207 9.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414l3.293 3.293 7.293-7.293a1 1 0 011.414 0z"
        clipRule="evenodd"
      />
    </Svg>
  );
...
export default SvgSelectionPinConfirm;
