...
export const mapboxDarkStyle = {
  ...
  layers: [
    ...
    },
    {
      ...
      id: 'wetland',
      paint: {
        'fill-color': 'hsla(125, 15%, 28%, 0.5)',
        'fill-opacity': ['interpolate', ['linear'], ['zoom'], 7, 0, 12, 1],
      },
    ...
    },
    {
      ...
      id: 'building',
      paint: {
        'fill-color': 'hsl(200, 20%, 18%)',
        'fill-opacity': ['interpolate', ['linear'], ['zoom'], 14.5, 0, 15.5, 1],
        'fill-outline-color': 'hsl(200, 10%, 10%)',
      },
