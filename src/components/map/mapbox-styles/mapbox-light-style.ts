 ...
 * Based on
 * "version":8,
 * "name":"AtB-Prod-Light-V2"
 * "id":"cm4si9gl500cx01r15pn8f8vh"
 */
export const mapboxLightStyle = {
  sources: {
    composite: {
  ...
  layers: [
    ...
    },
    {
      ...
      paint: {
        ...
        'fill-outline-color': 'hsl(200, 30%, 90%)',
      },
      'source-layer': 'building',
    },
    {
    ...
    },
    {
      ...
      layout: {
        ...
        'text-allow-overlap': true,
        'icon-image': '2019-ferry_entrance-13', // icon NOT EXISTING ATM, fix!
        'text-font': ['DIN Offc Pro Regular', 'Arial Unicode MS Regular'],
        'text-padding': 0,
        'text-anchor': 'top',
        'text-field': ['to-string', ['get', 'stopaccess']],
