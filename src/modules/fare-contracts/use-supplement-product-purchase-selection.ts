...
export function useSupplementProductPurchaseSelection({
  ...
  const selection = useMemo(() => {
    ...
    return builder
      ...
      .product(supplementProductFareProduct) // This is necessary because we might bave several supplement products, so getDefaultProduct in .forType can default to another.
