export const getMapboxDarkStyle = (
  ...
  return {
    sources: {
      composite: {
        url: `mapbox://mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v8,${mapboxNsrTilesetId}`,
        type: 'vector',
      },
    },
    glyphs: `mapbox://fonts/${mapboxUserName}/{fontstack}/{range}.pbf`,
    layers: [
      {
        id: 'land',
        type: 'background',
