...
import TravelCardInformation from '../FareProducts/TravelCardInformation';
...
const FareContractAndReservationsScrollView: React.FC<Props> = ({
  fareContracts,
  reservations,
  noItemsLabel,
  isRefreshing,
...
export default FareContractAndReservationsScrollView;
