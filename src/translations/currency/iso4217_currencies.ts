...
export type CurrencyISO4217Entry = {
  name: string;
  demonym: string;
  majorSingle: string;
  majorPlural: string;
...
export type CurrenciesISO4217Map = Record<string, CurrencyISO4217Entry>;

export const iso4217_currencies: CurrenciesISO4217Map = {
  AED: {
