...
const NotificationPermissionTexts = {
  title: _(
    'Få varslinger før billetten din utløper',
    'Get notifications before your ticket expires',
    'Få varsel før billetten din går ut',
  ),
  description: _(
