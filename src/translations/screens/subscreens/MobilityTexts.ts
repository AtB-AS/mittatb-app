...
export const MobilityTexts = {
  ...
  cityBike: {
    ...
    startTripView: {
      ...
      description: _(
        'Det kan ta litt tid før sykkelen slipper stativet og du kan dra den til deg.',
        'It may take a moment before the bike is released from the dock and you can pull it towards you.',
        'Det kan ta litt tid før sykkelen slepp stativet og du kan dra han til deg.',
      ),
    ...
    endManualTrip: {
      ...
      summary: _(
        'Parker i nærmeste stativ. Det tar noen sekunder før turen avsluttes i appen.',
        'Park at the nearest dock. It may take a few seconds before the trip is ended in the app.',
        'Parker i nærmeste stativ. Det tar nokre sekund før turen vert avslutta i appen.',
      ),
    },
  },
  loadingFailed: _(
...
export const ShmoWarnings = {
  bookingPaused: _(
    'Det har oppstått en feil og turen er pauset i våre systemer. Trykk på knappen nedenfor for å fortsette turen.',
    'An error has occurred and the trip is paused in our systems. Press the button below to continue the trip.',
    'Det har oppstått ein feil og turen er pauset i våre system. Trykk på knappen nedenfor for å fortsette turen.',
  ),
  vehicleDisabled: _(
